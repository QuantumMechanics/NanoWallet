function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        IMPORTANCE_TRANSFER_TITLE: 'Manage remote account',
        ...
        IMPORTANCE_TRANSFER_INFO_PART_1: 'Once an importance transaction has been included in a block it needs 6 hours to become active. After that you\'ll be able to choose a node to harvest on with a <i class="fa fa-play-circle-o"></i> button on your account page in the "Harvesting" panel.',
        ...
        PORTAL_HARVESTING_TEXT: 'Delegated harvesting is the feature that allows "mining" via a remote node even while your account is closed.',
        PORTAL_HARVESTING_BTN_1: 'Manage remote account',
        PORTAL_HARVESTING_BTN_2: 'Manage multisigs remote accounts',
        ...
        ALERT_MAINNET_DISABLED: 'Mainnet is disabled in current version',
